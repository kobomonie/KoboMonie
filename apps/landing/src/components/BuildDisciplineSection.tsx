...
const ConsistencyIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" fill="#00664E"/>
  </svg>
);

const AccountabilityIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z" fill="#00664E"/>
  </svg>
);

const PurposeIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" fill="#00664E"/>
  </svg>
);

const HabitsIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" fill="#00664E"/>
  </svg>
);
...
const Feature = ({ icon, title, description, index }: FeatureProps) => (
  ...
  >
    ...
    <div>
      <h3 className="font-['Avenir_LT_Std:85_Heavy',sans-serif] text-[#1f2937] text-base lg:text-lg leading-normal mb-1">
        {title}
      </h3>
...
const FEATURES = [
  {
    ...
    description: 'Automatic contributions help you save regularly without having to remember or force yourself',
  },
  {
    icon: <AccountabilityIcon />,
    title: 'Accountability That Works',
    description: 'Saving with others keeps you committed, not through pressure, but shared responsibility',
  },
  {
    icon: <PurposeIcon />,
    title: 'Purpose-Driven Saving',
    description: 'Save toward clear goals with timelines, so your money always has direction and meaning.',
  },
  {
    icon: <HabitsIcon />,
    title: 'Smarter Money Habits',
    description: 'Clear tracking and visibility help you understand your spending patterns and improve over time',
  },
];
