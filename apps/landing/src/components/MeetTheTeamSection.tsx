    ...
    <div className='p-2 text-center'>
      ...
      {linkedIn && (
        <a
          ...
          className="inline-flex  items-center justify-center gap-1.5 text-[#dcfce7] text-[10px] hover:text-white transition-colors font-['Avenir',sans-serif] leading-none h-[12px]"
        >
